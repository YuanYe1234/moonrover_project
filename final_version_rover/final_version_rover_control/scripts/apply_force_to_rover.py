...
rospy.init_node('apply_body_wrench_to_rover')
...
def get_sinkage():
    ...
    print('++++++++++++++++++++++++sinkage_right')
    print(0-sinkage_right)
    sinkage_left=request_left.link_state.pose.position.z
    print('++++++++++++++++++++++++sinkage_left')
    print(0-sinkage_left)
    sinkage_rear=request_rear.link_state.pose.position.z
    print('++++++++++++++++++++++++sinkage_rear')
    print(0-0.025-sinkage_rear)    
    return {'z_right':0-sinkage_right, 'z_left':0-sinkage_left, 'z_rear':0-0.025-sinkage_rear}
...
def set_force1():
    ...
    set_point_rear.z = 0#0-0.125

    FN_right=100000.0*z_right
    FN_left=100000.0*z_left
    FN_rear=100000.0*z_rear#(FN_left+FN_right)/ (20.48 * 2) *6  

    set_force_front_right = geometry_msgs.msg.Wrench()
    #set_force_front_right.force.z = 150.0 - 21 * vz_right
    set_force_front_right.force.z = FN_right - 2000 * vz_right
    ...
    set_force_front_left.force.z = FN_left - 2000 * vz_left
    #set_force_front_left.force.z = 150.0 - 21 * vz_left

    print('*******************front_left*******************up')
    print(set_force_front_left.force.z) 
    print('*******************front_left*******************down')   
    set_force_rear = geometry_msgs.msg.Wrench()
    set_force_rear.force.z = FN_rear - 2000 * vz_rear
    #set_force_rear.force.z = 5.1*6 - 21 * vz_rear
    print('*******************rear*******************up')
